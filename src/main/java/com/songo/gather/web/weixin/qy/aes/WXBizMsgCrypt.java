 ...
 */
package com.songo.gather.web.weixin.qy.aes;
...
public class WXBizMsgCrypt {
	 ...
	 */
	private WXBizMsgCrypt(String token, String encodingAesKey, String corpId) throws AesException {
	...
	public static WXBizMsgCrypt newInstance(String token, String encodingAesKey, String corpId) {
		try {
