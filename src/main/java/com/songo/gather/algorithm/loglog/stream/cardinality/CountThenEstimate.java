...
package com.songo.gather.algorithm.loglog.stream.cardinality;
...
import com.songo.gather.algorithm.loglog.util.ExternalizableUtil;
import com.songo.gather.algorithm.loglog.util.LogLogBuilder;
 ...
 * </p>
 */
public class CountThenEstimate implements Cardinality, Externalizable {
     ...
     */
    protected LogLogBuilder<Cardinality> builder;

    /**
     * Cardinality estimator
     * Null until tipping point is reached
     */
    protected Cardinality estimator;
     ...
     */
    public CountThenEstimate(int tippingPoint, LogLogBuilder<Cardinality> builder) {
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        if (tipped) {
            ...
            builder = (LogLogBuilder) in.readObject();
    ...
    @Override
    public Cardinality merge(Cardinality... estimators) throws CardinalityMergeException {
        if (estimators == null) {
    ...
    public static CountThenEstimate mergeEstimators(CountThenEstimate... estimators) throws CardinalityMergeException {
        ...
        if (numEstimators > 0) {
            List<Cardinality> tipped = new ArrayList<Cardinality>(numEstimators);
            ...
            if (!tipped.isEmpty()) {
                ...
                merged.estimator = merged.estimator.merge(tipped.toArray(new Cardinality[tipped.size()]));
            }
