...
package com.songo.gather.algorithm.loglog.stream.membership;
...
public class BloomFilter extends Filter {
    ...
    static CompactSerializer<BloomFilter> serializer_ = new BloomFilterSerializer();

    public static CompactSerializer<BloomFilter> serializer() {
        return serializer_;
    }
...
class BloomFilterSerializer implements CompactSerializer<BloomFilter> {
