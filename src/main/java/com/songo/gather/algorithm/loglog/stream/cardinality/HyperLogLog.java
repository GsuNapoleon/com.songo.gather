...
import com.songo.gather.algorithm.loglog.hash.MurmurHash;
import com.songo.gather.algorithm.loglog.util.Bits;
 ...
 * </p>
 */
public class HyperLogLog implements Cardinality, Serializable {
    ...
    public Cardinality merge(Cardinality... estimators) throws CardinalityMergeException {
        ...
        for (Cardinality estimator : estimators) {
    ...
    public static class Builder implements LogLogBuilder<Cardinality>, Serializable {
