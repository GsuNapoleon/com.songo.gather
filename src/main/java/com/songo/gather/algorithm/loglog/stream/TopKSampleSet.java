...
public class TopKSampleSet<T> implements SampleSet<T> {
    ...
    public TopKSampleSet() {
        this(7);
    }

    public TopKSampleSet(int capacity) {
        this(capacity, new Random());
    }

    public TopKSampleSet(int capacity, Random random) {
