...
import com.songo.gather.algorithm.loglog.hash.Lookup3Hash;
...
public class AdaptiveCounting extends LogLog {
     ...
     */
    @Override
    public Cardinality merge(Cardinality... estimators) throws LogLogMergeException {
    ...
    public static class Builder implements LogLogBuilder<Cardinality>, Serializable {
         ...
         */
        public static LogLogBuilder<Cardinality> obyCount(long maxCardinality) {
            if (maxCardinality <= 0) {
